...
# ── run all ───────────────────────────────────────────────────────────────────
for cond_label, cond_folder, gas_str, bp_str, k75, xlim, plim_max in CONDITIONS:
    build_figure(cond_label, cond_folder, gas_str, bp_str, k75,
                 xlim, plim_max, MAIN_ORDER,  MAIN_CLR)
    build_figure(cond_label, cond_folder, gas_str, bp_str, k75,
                 xlim, plim_max, OTHER_ORDER, OTHER_CLR)
