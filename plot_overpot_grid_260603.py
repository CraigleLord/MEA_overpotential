"""
Overpot_grid_Main and Overpot_grid_Other saved to the 260603 folder.
VC Polyol + Air BP uses the 260603 reproducibility data; everything else
falls back to ALT_DATA.
"""
            ...
            if fp is None:
                ...
                try:
                    ...
                    draw_panel(ax, I_mA, V, R_ohm, R_pro, erev, intercept, slope,
                               ...
                               ymax=ymax)
                    print(f"  {samp}/{cond_folder}: {os.path.basename(fp)}")
